...
import pytorch_wheel_installer
...
project = pytorch_wheel_installer.__name__
author = pytorch_wheel_installer.__author__
copyright = f"{datetime.now().year}, {author}"
version = release = pytorch_wheel_installer.__version__
